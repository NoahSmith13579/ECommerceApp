    ...
    public class SeedData
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            var products = new Product[]
            {
                ...
                new Product{Name="Hiking Shoes", CategoryId=4, Price=60.00m, Description="Comfortable shoes for hiking", ImgUrl="/Content/Images/hiking_shoes"},
                ...
                new Product{Name="The Stranger", CategoryId=7, Price=11.59m, Description="By Alber Camus", ImgUrl="/Content/Images/the_stranger.jpg"},
            };
