...
namespace ShoppingApp.Migrations
{
    ...
    [Migration("20230419165227_OrderDateStringToDateTime")]
    partial class OrderDateStringToDateTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoppingApp.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ShoppingApp.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShoppingApp.Models.Address", b =>
                {
                    b.HasOne("ShoppingApp.Data.ApplicationUser", "User")
                        .WithOne("Address")
                        .HasForeignKey("ShoppingApp.Models.Address", "UserId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShoppingApp.Models.OrderItem", b =>
                {
                    b.HasOne("ShoppingApp.Models.Order", null)
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("ShoppingApp.Models.ShoppingCart", b =>
                {
                    b.HasOne("ShoppingApp.Data.ApplicationUser", "User")
                        ...
                        .HasForeignKey("ShoppingApp.Models.ShoppingCart", "UserId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
